...
public class ItemController {
	...
	public ItemDTO getItem(@PathVariable("id") String id) {
		return itemService.loadItem(id).map(this::mapToDTO).orElseThrow(() -> new ItemNotFoundException(id));
	}
	...
	{
		return itemService.loadItems(pageIndex, pageSize).map(this::mapToDTO);
	}
